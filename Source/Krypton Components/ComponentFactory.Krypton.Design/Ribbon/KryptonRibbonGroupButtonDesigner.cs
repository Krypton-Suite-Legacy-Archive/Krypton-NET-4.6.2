        ...
        private void OnContextMenu(object sender, MouseEventArgs e)
        {
            if (_ribbonButton?.Ribbon != null)
            {
                ...
                if (_cms == null)
                {
                    ...
                    _moveFirstMenu = new ToolStripMenuItem("Move Button First", ComponentFactory.Krypton.Design.Properties.Resources.MoveFirst, OnMoveFirst);
                    _movePreviousMenu = new ToolStripMenuItem("Move Button Previous", ComponentFactory.Krypton.Design.Properties.Resources.MovePrevious, OnMovePrevious);
                    _moveNextMenu = new ToolStripMenuItem("Move Button Next", ComponentFactory.Krypton.Design.Properties.Resources.MoveNext, OnMoveNext);
                    _moveLastMenu = new ToolStripMenuItem("Move Button Last", ComponentFactory.Krypton.Design.Properties.Resources.MoveLast, OnMoveLast);
                    _deleteButtonMenu = new ToolStripMenuItem("Delete Button", ComponentFactory.Krypton.Design.Properties.Resources.delete2, OnDeleteButton);
